...
PROJECT_DIRECTION = "A per jurisdiction, per form regression harness for tax compliance agents - the release gate that lets Notice Fixture's AI agents file faster and prove it."
